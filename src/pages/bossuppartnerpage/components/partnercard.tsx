...
const PartnerCard = ({
    ...
    return (
        <div>
            ...
            <div className="bg-white px-4 rounded-lg computer-only flex justify-center items-center">

                <div className="bg-[#ffffff] py-3 mb-3 flex items-center ">
                    ...
                    <div>
                        ...
                        <div onClick={() => { }} className="flex items-center gap-2 bg-[#f4f4f4] py-1 px-2 rounded-lg">
                            <Assets.Linkicon />
