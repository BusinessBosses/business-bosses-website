      ...
      <div className="flex flex-row pt-5 items-center justify-center gap-4 mb-4">
        <div className="flex flex-col items-center">
          <button
            ...
            onClick={() =>
              router.push(RoutesPath.ChatRoom, { state: { user: shop?.user } })
            }
          >
        ...
        <div className="flex flex-col items-center">
          <button
            className="bg-gray-200 rounded-full p-2 hover:bg-gray-300"
            onClick={() =>
              router.push(RoutesPath.sellerreview, { state: shop?.user! })
            }
          >
                ...
                >
                  {!item.hasOwnProperty("serviceType") && item.isActive ? (
                    <ProductCard
                      ...
                      onCardClick={() =>
                        router.push(RoutesPath.expandedshop, {
                          state: { data: item },
                        })
                      }
                      onOrderClick={() =>
