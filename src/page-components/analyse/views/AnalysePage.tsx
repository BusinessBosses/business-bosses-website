    ...
    return (
        <div>
            ...
            <div className=" pt-10 bg-white mobile-only" style={{ height: "100vh", borderTop: '15px solid rgba(244, 244, 244, 1)' }}>
                ...
                <Analyserows leadingSvg={<Assets.Analyse />} middleText={"Analyse my Profile"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.analyseprofilepage) }} />
                <Analyserows leadingSvg={<Assets.Connectrelevant />} middleText={"Connect me to relevant people"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.connectrelevant) }} />
                <Analyserows leadingSvg={<Assets.Ranking />} middleText={"Show my ranking"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.rankingpage) }} />
                <Analyserows leadingSvg={<Assets.Explore />} middleText={"Explore Business Bosses"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.explorebusinessbosses) }} />
                ...
                <div className="computer-content">
                    ...
                    >
                        ...
                        <div className=" pt-10 bg-white" style={{ height: "100vh", }}>
                            ...
                            <Analyserows leadingSvg={<Assets.Analyse />} middleText={"Analyse my Profile"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.analyseprofilepage) }} />
                            <Analyserows leadingSvg={<Assets.Connectrelevant />} middleText={"Connect me to relevant people"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.connectrelevantpage) }} />
                            <Analyserows leadingSvg={<Assets.Ranking />} middleText={"Show my ranking"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.rankingpage) }} />
                            <Analyserows leadingSvg={<Assets.Explore />} middleText={"Explore Business Bosses"} endingSvg={<Assets.Nexticon stroke="#F21C29" />} onClick={() => { router.push(RoutesPath.explorebusinessbosses) }} />
