...
const EditProfilePage = ({partnerData, partnerDatatile }: Props) => {
            ...
            <div className="">
              <div className=" flex items-center gap-3">
                {profile?.email != `${process.env.REACT_APP_DUMMY_EMAIL}` ?
                  <ComputerProfileDetails data={profile!} /> : <Computerlefttabsignedoutuser data={profile!} />}
              </div>
            </div>
          </div>
...
<div className="computer-only min-h-screen h-full bg-white">
      <div className=" top-0 w-full z-50 " style={{ position: 'sticky', top: 0, zIndex: 0, }}>
