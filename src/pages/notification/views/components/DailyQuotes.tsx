      ...
      <div className="mobile-only">
        <div className="bg-[#F4F4F4] p-5">
          ...
          <p className="text-[#6B6969] text-sm mt-3">
            Lorem ipsum dolor sit amet consectetur. Cras viverra porta eget congue
            massa eget pellentesque a. Enim molestie massa arcu vitae dui pharetra
            viverra varius mus. Ullamcorper quam in turpis sit
          </p>
