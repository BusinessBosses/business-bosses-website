    ...
    return (
        ...
        <div className="mobile-only bg-white " style={{ height: "100vh" }} >
            ...
            <div className='px-5 pt-5'>
                <FilledButtonsmall className='py-4 w-full' onClick={() => router.push(RoutesPath.home)} text={'Retry Payment'} />
                <OutlinedButtonsmall className='py-4 mt-5 w-full' onClick={() => router.push(RoutesPath.home)} text={'Cancel'} />
            </div>
