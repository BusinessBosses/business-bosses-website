  ...
  return (
    <div>
      ...
      <div className="px-5 mobile-only">
        <Tab onClick={() => { router.push(RoutesPath.communityrules); } } text="Community Rules" partnerData={partnerData}   partnerDatatile={partnerDatatile} />
        <Tab onClick={() => { router.push(RoutesPath.invitetandcs); } } text="Invite a friends terms & conditions" partnerData={partnerData}   partnerDatatile={partnerDatatile} />
