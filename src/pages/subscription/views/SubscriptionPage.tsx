...
const SubscriptionPage = () => {
  ...
  const getMoneyText = () => {
    if (selectedIndex === 0) {
      return <span>Upgrade to a premium boss experience at only <span style={{ color: "red" }}>$9.99/month</span></span>;
    } else {
      return <span>Upgrade to a premium boss experience at only <span style={{ color: "red" }}>$49.99/year</span></span>;
    }
  };
  return (
    <div style={{ textAlign: "center", height: "100vh", background: "linear-gradient(180deg, #CCDCEE -90%, #FFF 100%)" }}>
        ...
        <div className="p-5">
          ...
          <div className="px-8 py-10" style={{
            ...
            <img src={Assets.Rocket} alt="" />
              <span style={{ marginLeft: '8px' }}>Boost post FREE with coins</span>
            </div>
            <div style={{ display: 'flex' }}>
              <Assets.Moreconnections/>
              <span style={{ marginLeft: '8px' }}>More connections & referrals</span>
            </div>
            <div style={{ display: 'flex' }}>
              <Assets.Rankingicon/>
              <span style={{ marginLeft: '8px' }}>Rank higher on posts & listing</span>
            </div>
          </div>
          ...
          <div className="mt-5">
            <FilledButton
              onClick={() => { }}
              text={selectedIndex === 0 ? "Subscribe at $4.99" : "Subscribe at $49.99"}
